...
namespace Boskov.Vladimir
{
    ...
    public class StatusDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(amountRect, property.FindPropertyRelative("rate"), GUIContent.none);
            EditorGUI.PropertyField(unitRect, property.FindPropertyRelative("current"), GUIContent.none);
